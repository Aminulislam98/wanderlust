...
const AddDestination = () => {
  const onSubmit = async (e) => {
    ...
    console.log("destination data form client side:", data);
  };
  return (
    <div className="max-w-3xl mx-auto w-full py-10">
      <h1 className="py-2 font-semibold">Add Destination</h1>
      <form onSubmit={onSubmit} className="p-10 space-y-8 border rounded-3xl">
